<%-- 
    Document   : 5A
    Created on : 6 Nov, 2014, 8:14:57 AM
    Author     : Sony
--%>
...
<div id="main">
 ...
 <div id="tourist" class="two">
            ...
            <div id="vbody1">
                <br><br><br><br>
                <img src="jw2.jpg"><br><br><br><hr><br><br><br>
                <embed src="jw1.jpg" width="420" height="300"><img src="jw31.jpg" width="300"><div id="vimg"> </div>
                <br><br><img src="jw32.jpg"><br><br><br><br>
                <img src="jw41.jpg"><br>
