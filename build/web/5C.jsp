<%-- 
    Document   : 5C
    Created on : 6 Nov, 2014, 8:16:49 AM
    Author     : Sony
--%>
...
<html>
 ...
 <div id="tourist" class="two">
            ...
            <div id="vbody1">
                <br><br><br><br>
                <img src="gp3.jpg"><br><br><br><hr><br><br><br>
                <embed src="gp1.jpg" width="420" height="300"><div id="vimg"> </div>
                
                <img src="gp2.jpg"><br><br><br><hr><br><br><br>
