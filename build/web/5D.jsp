<%-- 
    Document   : 5D
    Created on : 6 Nov, 2014, 8:17:23 AM
    Author     : Sony
--%>
...
<html>
 ...
 <div id="tourist" class="two">
            ...
            <div id="vbody1">
                <br><br><br><br>
                <img src="mv2.jpg"><br><br><br><hr><br><br><br>
                <embed src="mv1.jpg" width="420" height="300"><div id="vimg"> </div>
                <br><br><img src="mv3.jpg"><br><br><br><br>
