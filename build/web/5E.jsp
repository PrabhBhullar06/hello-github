<%-- 
    Document   : 5E
    Created on : 6 Nov, 2014, 8:17:54 AM
    Author     : Sony
--%>
...
<html>
 ...
 <div id="tourist" class="two">
            ...
            <div id="vbody1">
                <br><br><br><br>
                <img src="kccc.jpg"><br><br><br><hr><br><br><br>
                <embed src="kcc.jpg" width="420" height="300"><img src="kc31.jpg" width="300"><div id="vimg"> </div>
                <br><br><img src="kc41.jpg"><br><br><br><br>
                <br><img src="kc51.jpg">
