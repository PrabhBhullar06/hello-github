<%-- 
    Document   : 5star
    Created on : 6 Nov, 2014, 11:44:53 AM
    Author     : SAURABH
--%>
                ...
                <div id="club" class="two">
                 ...
                 <div id="arezona" style="width: 900px;min-height: 120px;">
                     <br><br><div id="aimg" style="float: left;">
                         <a href="5A.jsp"><img src="jw1.jpg" width="200" height="200" style="border-radius: 10px;"></a></div>
                    <div id="ainfo" style="float: left;">
                        <div id="namea" style="font-size: 20px;font-family: sans-serif;">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;
                            <a href="5A.jsp" style="color: black;"><b>Hotel JW Marriot</b></a><br><br></div>
                        <div id="infoimga">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="jw.JPG"></div>
                    </div>
                  ...
                  <div id="arezona" style="width: 900px;min-height: 120px;">
                     <br><br><div id="aimg" style="float: left;">
                         <a href="5B.jsp"><img src="pp1.jpg" width="200" height="200" style="border-radius: 10px;"></a></div>
                    <div id="ainfo" style="float: left;">
                        <div id="namea" style="font-size: 20px;font-family: sans-serif;">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;
                            <a href="5B.jsp" style="color: black;"><b>Hotel Park Plaza</b></a><br><br></div>
                        <div id="infoimga">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <img src="park.JPG"></div>
                    </div>
                 </div><div id="cleara" style="clear: both;"></div><br><br><hr>
                 
                  <div id="arezona" style="width: 900px;min-height: 120px;">
                     <br><br><div id="aimg" style="float: left;">
                         <a href="5C.jsp"><img src="gp1.jpg" width="200" height="200" style="border-radius: 10px;"></a></div>
                    <div id="ainfo" style="float: left;">
                        <div id="namea" style="font-size: 20px;font-family: sans-serif;">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;
                            <a href="5C.jsp" style="color: black;"><b>Hotel Golden Palms</b></a><br><br></div>
                        <div id="infoimga">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="gol.JPG"></div>
                    </div>
                 </div><div id="cleara" style="clear: both;"></div><br><br><hr>
                  ...
                  <div id="arezona" style="width: 900px;min-height: 120px;">
                     <br><br><div id="aimg" style="float: left;">
                         <a href="5D.jsp"><img src="mv1.jpg" width="200" height="200" style="border-radius: 10px;"></a></div>
                    <div id="ainfo" style="float: left;">
                        <div id="namea" style="font-size: 20px;font-family: sans-serif;">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;
                            <a href="5D.jsp" style="color: black;"><b>Hotel Mount View</b></a><br><br></div>
                        <div id="infoimga">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="mount.JPG"></div>
                    </div>
                 </div><div id="cleara" style="clear: both;"></div><br><br><hr>
                 
                  <div id="arezona" style="width: 900px;min-height: 120px;">
                     <br><br><div id="aimg" style="float: left;">
                         <a href="5E.jsp"><img src="kcc.jpg" width="200" height="200" style="border-radius: 10px;"></a></div>
                    <div id="ainfo" style="float: left;">
                        <div id="namea" style="font-size: 20px;font-family: sans-serif;">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;
                            <a href="5E.jsp" style="color: black;"><b>Hotel KC Royal Park</b></a><br><br></div>
                        <div id="infoimga">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="kcr.JPG"></div>
                    </div>
                 </div><div id="cleara" style="clear: both;"></div><br><br><hr>
