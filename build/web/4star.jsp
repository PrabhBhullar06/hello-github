<%-- 
    Document   : 4star
    Created on : 6 Nov, 2014, 11:30:16 AM
    Author     : SAURABH
--%>
                ...
                <div id="club" class="two">
                 ...
                 <div id="arezona" style="width: 900px;min-height: 120px;">
                     <br><br><div id="aimg" style="float: left;">
                         <a href="4A.jsp"><img src="bv1.jpg" width="200" height="200" style="border-radius: 10px;"></a></div>
                    <div id="ainfo" style="float: left;">
                        <div id="namea" style="font-size: 20px;font-family: sans-serif;">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;
                            <a href="4A.jsp" style="color: black;"><b>Hotel Bella Vista</b></a><br><br></div>
                        <div id="infoimga">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="bella.JPG"></div>
                    </div>
                  ...
                  <div id="arezona" style="width: 900px;min-height: 120px;">
                     <br><br><div id="aimg" style="float: left;">
                         <a href="4B.jsp"><img src="taj1_1.jpg" width="200" height="200" style="border-radius: 10px;"></a></div>
                    <div id="ainfo" style="float: left;">
                        <div id="namea" style="font-size: 20px;font-family: sans-serif;">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;
                            <a href="4B.jsp" style="color: black;"><b>Hotel Taj</b></a><br><br></div>
                        <div id="infoimga">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <img src="taj.JPG"></div>
                    </div>
                  ...
                  <div id="arezona" style="width: 900px;min-height: 120px;">
                     <br><br><div id="aimg" style="float: left;">
                         <a href="4C.jsp"><img src="toy1.jpg" width="200" height="200" style="border-radius: 10px;"></a></div>
                    <div id="ainfo" style="float: left;">
                        <div id="namea" style="font-size: 20px;font-family: sans-serif;">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;
                            <a href="4C.jsp" style="color: black;"><b>Hotel Toy</b></a><br><br></div>
                        <div id="infoimga">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="toy.JPG"></div>
                    </div>
                 </div><div id="cleara" style="clear: both;"></div><br><br><hr>
                  ...
                  <div id="arezona" style="width: 900px;min-height: 120px;">
                     <br><br><div id="aimg" style="float: left;">
                         <a href="4D.jsp"><img src="kr1.jpg" width="200" height="200" style="border-radius: 10px;"></a></div>
                    <div id="ainfo" style="float: left;">
                        <div id="namea" style="font-size: 20px;font-family: sans-serif;">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;
                            <a href="4D.jsp" style="color: black;"><b>Hotel KC Cross Road</b></a><br><br></div>
                        <div id="infoimga">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="kccross.JPG"></div>
                    </div>
                 </div><div id="cleara" style="clear: both;"></div><br><br><hr>
                 
                  <div id="arezona" style="width: 900px;min-height: 120px;">
                     <br><br><div id="aimg" style="float: left;">
                         <a href="4E.jsp"><img src="m1.jpg" width="200" height="200" style="border-radius: 10px;"></a></div>
                    <div id="ainfo" style="float: left;">
                        <div id="namea" style="font-size: 20px;font-family: sans-serif;">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;
                            <a href="4E.jsp" style="color: black;"><b>Hotel Maya</b></a><br><br></div>
                        <div id="infoimga">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="maya.JPG"></div>
                    </div>
                 </div><div id="cleara" style="clear: both;"></div><br><br><hr>
        </div>
        </div>
