<%-- 
    Document   : 3star
    Created on : 6 Nov, 2014, 11:12:49 AM
    Author     : SAURABH
--%>
                ...
                <div id="club" class="two">
                 ...
                 <div id="arezona" style="width: 900px;min-height: 120px;">
                     <br><br><div id="aimg" style="float: left;">
                         <a href="3A.jsp"><img src="hometel-chandigarh-chandigarh-image-53a9a519e4b0ae85671c8bb2.jpg" width="200" height="200" style="border-radius: 10px;"></a></div>
                    <div id="ainfo" style="float: left;">
                        <div id="namea" style="font-size: 20px;font-family: sans-serif;">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;
                            <a href="3A.jsp" style="color: black;"><b>Hotel Hometel</b></a><br><br></div>
                        <div id="infoimga">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="hometel.JPG"></div>
                    </div>
                  ...
                  <div id="arezona" style="width: 900px;min-height: 120px;">
                     <br><br><div id="aimg" style="float: left;">
                         <a href="3B.jsp"><img src="hotel-antheia-chandigarh-image-53a9a67ee4b0ae85671e9847.jpg" width="200" height="200" style="border-radius: 10px;"></a></div>
                    <div id="ainfo" style="float: left;">
                        <div id="namea" style="font-size: 20px;font-family: sans-serif;">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;
                            <a href="3B.jsp" style="color: black;"><b>Hotel Antheia</b></a><br><br></div>
                        <div id="infoimga">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <img src="anethia.JPG"></div>
                    </div>
                 </div><div id="cleara" style="clear: both;"></div><br><br><hr>
                 
                  <div id="arezona" style="width: 900px;min-height: 120px;">
                     <br><br><div id="aimg" style="float: left;">
                         <a href="3C.jsp"><img src="hotel-kwality-regency-chandigarh-image-53aa8089e4b03bbf5b0855b5.jpg" width="200" height="200" style="border-radius: 10px;"></a></div>
                    <div id="ainfo" style="float: left;">
                        <div id="namea" style="font-size: 20px;font-family: sans-serif;">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;
                            <a href="3C.jsp" style="color: black;"><b>Hotel Kwality Regency</b></a><br><br></div>
                        <div id="infoimga">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="kwality.JPG"></div>
                    </div>
                 </div><div id="cleara" style="clear: both;"></div><br><br><hr>
                 
                  <div id="arezona" style="width: 900px;min-height: 120px;">
                     <br><br><div id="aimg" style="float: left;">
                         <a href="3D.jsp"><img src="k-c-residency-chandigarh-hotel-image-524f2ecfcd83ae849ed78935.jpg" width="200" height="200" style="border-radius: 10px;"></a></div>
                    <div id="ainfo" style="float: left;">
                        <div id="namea" style="font-size: 20px;font-family: sans-serif;">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;
                            <a href="3D.jsp" style="color: black;"><b>Hotel KC Residency</b></a><br><br></div>
                        <div id="infoimga">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="kc.JPG"></div>
                    </div>
                 </div><div id="cleara" style="clear: both;"></div><br><br><hr>
                  ...
                  <div id="arezona" style="width: 900px;min-height: 120px;">
                     <br><br><div id="aimg" style="float: left;">
                         <a href="3E.jsp"><img src="lemon-tree-hotel-chandigarh-chandigarh-image-53a9b163e4b07bca39c3c12b.jpg" width="200" height="200" style="border-radius: 10px;"></a></div>
                    <div id="ainfo" style="float: left;">
                        <div id="namea" style="font-size: 20px;font-family: sans-serif;">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;
                            <a href="3E.jsp" style="color: black;"><b>Hotel Lemon Tree</b></a><br><br></div>
                        <div id="infoimga">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="lemon.JPG"></div>
                    </div>
                 </div><div id="cleara" style="clear: both;"></div><br><br><hr>
        </div>
        </div>
