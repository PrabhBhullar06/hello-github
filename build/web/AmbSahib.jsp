<%-- 
    Document   : AmbSahib
    Created on : 3 Nov, 2014, 1:51:35 PM
    Author     : Sony
--%>
    ...
    <body>
        <div id="main">
         ...
         <div id="div">
            ...
            <div id="vbody1">
                <br><br><br><br>
                <img src="amb1.jpg"><br><br><br><hr><br><br><br>
                <img src="amb-sahib-gurudwara-images-photos-5178cc37e4b0f293655f57e1.jpg" width="420" height="300"><div id="vimg"> <br><br><img src="animg.JPG" ></div>
                <br><br><img src="amb3.jpg"><br><br><br><br>
                <img src="amb4.jpg"> 
            </div>
         </div>
