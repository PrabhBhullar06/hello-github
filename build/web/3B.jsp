<%-- 
    Document   : 3B
    Created on : 5 Nov, 2014, 1:56:44 PM
    Author     : Sony
--%>
...
<div id="main">
       ...
       <div id="login"  >
         ...
         <div id="div">
            ...
            <div id="vbody1">
                <br><br><br><br>
                <img src="hotel1.jpg"><br><br><br><hr><br><br><br>
                <embed src="hotel-antheia-chandigarh-image-53a9a67ee4b0ae85671e9847.jpg" width="420" height="300"><div id="vimg"> </div>
                <br><br><img src="hotel4.jpg"><br><br><br><br>
                <img src="hotel3.jpg"><br>
