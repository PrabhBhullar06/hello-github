<%-- 
    Document   : Architect
    Created on : 23 Oct, 2014, 12:32:59 AM
    Author     : SAURABH
--%>
        ...
        <div id="div">
           ...
           <div id="city">
            ...
            <div id="menuu">
                ...
                <a href="Architect.jsp" class="five"  style="color: red">The Architect</a><hr><br>
               
                <a href="history2.jsp" class="five">History</a><hr><br>
                <a href="events.jsp" class="five">Annual Events Calendar</a><hr><br>
                <a href="map.jsp" class="five">Map</a><hr>
           </div>
            <div id="empty3"></div>
            <div id="cityimg">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="leimg.jpg" height="200" width="580">
            </div>
         </div>
         <div id="empta">
                <div id="empty4"></div>
                <div id="le">
                    Le Corbusier<hr>
                    Charles-Edouard Jeanneret-Gris<hr>
                </div>
                <div id="archt"> <br><br><br><br><br><br><br><br><br> 
                <div id="pi">
                    <b>PERSONAL INFORMATION</b><hr>
                </div>
                <div id="letext">
                ...
                <div id="ltp">
                    <b>Name:</b> Charles-Édouard Jeanneret-Gris<br>
                    <b>Nationality:</b> Swiss / French<br>
                    <b>Birth date:</b> October 6, 1887<br>
                    <b>Birth place:</b> La Chaux-de-Fonds, Switzerland<br>
                    <b>Date of death:</b> August 27, 1965 (aged 77)<br>
                    <b>Place of death:</b> Roquebrune-Cap-Martin, France<br>
                </div>
