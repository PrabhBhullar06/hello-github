<%-- 
    Document   : 4C
    Created on : 6 Nov, 2014, 8:13:54 AM
    Author     : Sony
--%>
    ...
    <body>
       ...
       <div id="login"  >
         ...
         <div id="div">
            ...
            <div id="vbody1">
                <br><br><br><br>
                <img src="toy2.jpg"><br><br><br><hr><br><br><br>
                <embed src="toy1.jpg" width="420" height="300"><img src="toy3.jpg" width="300"><div id="vimg"> </div>
                <br><br><img src="toy4.jpg"><br><br><br><br>
